...
/// @file SimpleBusLT.h
///
/// @brief Simple bus interconnect for TLM-2.0 LT examples
///
/// @details
///   Template-based address-decoding bus that routes b_transport calls from
///   multiple initiators to multiple targets. Uses the upper 4 address bits
///   to determine the target port ID.
//
//==============================================================================
