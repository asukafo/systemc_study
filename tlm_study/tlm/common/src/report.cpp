...
/// @file report.cpp
///
/// @brief Helper functions for printing TLM-2.0 transactions and phases
///
/// @details
///   Provides human-readable string conversions for tlm_phase, tlm_sync_enum,
///   and tlm_response_status, plus formatted printing of generic payload and
///   DMI properties.
//
//==============================================================================
